...
# print('SanjanaRajput01'.isalnum())
# print('SanjanaRajput'.isalpha())
# print('3001K'.isdigit())
# print('sdsdsd'.islower())
# print('SanjanaRajput'.isupper())
# print('SanjanaRajput01'.istitle())
# print(''.istitle())
# print(''.isspace())
